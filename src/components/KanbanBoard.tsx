...
const DroppableColumn = ({
  ...
  return (
    <Card className="min-w-75 flex-shring-0 shadow-md p-0">
      <CardHeader
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant={"ghost"}
                size={"icon"}
                className="h-6 w-6 text-white hover:bg-whiet-20"
              >
      ...
      <CardContent
        ref={setNodeRef}
        className={`space-y-2 pt-4 bg-gray-50/50 min-h-100 rounded-br-lg ${isOver ? "ring-2 ring-blue-500" : ""}`}
      >
        <SortableContext
